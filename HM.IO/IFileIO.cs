...
/// <include file='IFileIO.xml' path='IFileIO/Class[@name="IFileIO"]/*' />
public interface IFileIO
{
    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="Exists[EntryPath]"]/*' />
    Boolean Exists(EntryPath path);

    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="OpenRead[EntryPath]"]/*' />
    Stream OpenRead(EntryPath path);

    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="OpenWrite[EntryPath]"]/*' />
    Stream OpenWrite(EntryPath path);

    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="Rename[EntryPath,EntryPath]"]/*' />
    void Rename(EntryPath sourceFilePath, EntryPath destinationFilePath);

    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="Delete[EntryPath]"]/*' />
    ...
    /// <include file='IFileIO.xml' path='IFileIO/Methods/Instance[@name="SetFileAttributes[EntryPath,FileAttributes]"]/*' />
