...
public class FileIO : IFileIO
{
    ...
    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="Rename[EntryPath,EntryPath]"]/*' />
    ...
    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="Delete[EntryPath]"]/*' />
    public void Delete(EntryPath filePath)
    {
        File.Delete(filePath.StringPath);
    }

    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="OpenRead[EntryPath]"]/*' />
    public Stream OpenRead(EntryPath filePath)
    {
        return File.OpenRead(filePath.StringPath);
    }

    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="OpenWrite[EntryPath]"]/*' />
    ...
    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="GetFileAttributes[EntryPath]"]/*' />
    public FileAttributes GetFileAttributes(EntryPath path)
    {
        return File.GetAttributes(path.StringPath);
    }

    /// <include file='FileIO.xml' path='FileIO/Methods/Instance[@name="SetFileAttributes[EntryPath,FileAttributes]"]/*' />
